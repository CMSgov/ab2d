...
import static gov.cms.ab2d.job.service.JobServiceIT.CLIENTID;
import static gov.cms.ab2d.job.service.JobServiceIT.CONTRACT_NUMBER;
import static gov.cms.ab2d.job.service.JobServiceIT.LOCAL_HOST;
import static gov.cms.ab2d.job.service.JobServiceIT.setupRegularClientSecurityContext;
...
@Testcontainers
class MaxJobsIT extends JobCleanup {
    ...
    private void createMaxJobs() {
        ...
        startJobDTO = new StartJobDTO(contract.getContractNumber(), organization,
                EOB, LOCAL_HOST, FHIR_NDJSON_CONTENT_TYPE, null, null, STU3);
