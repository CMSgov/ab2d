output "ab2d_cloud_watch_logs_policy_name" {
  value = module.core.ab2d_cloud_watch_logs_policy_name
}

output "ab2d_instance_profile" {
  value = module.core.ab2d_instance_profile
}
...
output "private_subnet_a_id" {
  value = module.core.private_subnet_a_id
}

output "private_subnet_b_id" {
  value = module.core.private_subnet_b_id
}
