...
1. Configure the "CMS Cloud Service Request" page as follows
   ...
   - **Summary:** Onboard AB2D Management to Cloud Protection Manager

   - **CMS Business Unit:** OIT

   - **Project Name:** AB2D Management

   - **Account Alias:** aws-cms-oit-iusg-acct97
   ...
   - **Description:**
     ...
     ```
     Onboard AB2D Management to Cloud Protection Manager
