...
create table IF NOT EXISTS sandbox_2026 partition of sandbox
    for values in (2026);

create table IF NOT EXISTS coverage_anthem_united_2026 partition of coverage_anthem_united
    for values in (2026);

create table  IF NOT EXISTS coverage_bcbs_2026 partition of coverage_bcbs
    for values in (2026);

create table  IF NOT EXISTS coverage_centene_2026 partition of coverage_centene
    for values in (2026);

create table  IF NOT EXISTS coverage_cigna1_2026 partition of coverage_cigna1
    for values in (2026);

create table  IF NOT EXISTS coverage_cigna2_2026 partition of coverage_cigna2
    for values in (2026);

create table  IF NOT EXISTS coverage_cvs_2026 partition of coverage_cvs
    for values in (2026);

create table  IF NOT EXISTS coverage_humana_2026 partition of coverage_humana
    for values in (2026);

create table  IF NOT EXISTS coverage_united1_2026 partition of coverage_united1
    for values in (2026);

create table  IF NOT EXISTS coverage_united_2026 partition of coverage_united2
    for values in (2026);

create table  IF NOT EXISTS coverage_mutual_dean_clear_cambia_rite_2026 partition of coverage_mutual_dean_clear_cambia_rite
    for values in (2026);

create table  IF NOT EXISTS coverage_misc_2026 partition of coverage_misc
    for values in (2026);
