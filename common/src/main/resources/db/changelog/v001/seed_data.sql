...
INSERT INTO user_account (id, user_name, first_name, last_name, email, sponsor_id, enabled) VALUES ((select nextval('hibernate_sequence')),
    'EileenCFrierson@example.com', 'Eileen', 'Frierson', 'EileenCFrierson@example.com', (select id from sponsor where hpms_id=999), true);

INSERT INTO user_role (user_account_id, role_id) VALUES ((SELECT id FROM user_account WHERE user_name='EileenCFrierson@example.com'),
