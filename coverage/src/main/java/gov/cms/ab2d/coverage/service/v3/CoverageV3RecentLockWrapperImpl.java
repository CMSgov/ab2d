...
@Slf4j
@Component("recentCoverageLock")
public class CoverageV3RecentLockWrapperImpl implements CoverageV3LockWrapper {

    private static final String COVERAGE_V3_LOCK_NAME_PREFIX = "COVERAGE_V3_RECENT_LOCK_";
    private static final int LOCK_TTL_MILLIS = 120_000; // 2 minutes
    private final JdbcLockRegistry lockRegistry;

    public CoverageV3RecentLockWrapperImpl(ApplicationContext context, DataSource dataSource) {
