...
class SearchUtilsTest {
    ...
    void testGetPatientClass() {
        assertEquals(org.hl7.fhir.dstu3.model.Patient.class, SearchUtils.getPatientClass(Versions.FhirVersions.R3));
    ...
    void testGetBundleClass() {
        assertEquals(org.hl7.fhir.dstu3.model.Bundle.class, SearchUtils.getBundleClass(Versions.FhirVersions.R3));
