...
class ExtensionUtilsTest {
    ...
    void testExtensions() {
        ...
        IBase extension = ExtensionUtils.createExtension(eob, mbiIdCurrent, true, Versions.FHIR_VERSIONS.R3);
        ExtensionUtils.addExtension(eob, extension, Versions.FHIR_VERSIONS.R3);
