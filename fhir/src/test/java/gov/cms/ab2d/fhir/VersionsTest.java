...
class VersionsTest {
    ...
    void executeInstantiate() throws NoSuchMethodException, IllegalAccessException, InstantiationException, VersionNotSupported, InvocationTargetException, ClassNotFoundException {
        Object obj1 = Versions.instantiateClass(Versions.FHIR_VERSIONS.R4, "ExplanationOfBenefit");
        assertEquals(org.hl7.fhir.r4.model.ExplanationOfBenefit.class, obj1.getClass());
        Object obj2 = Versions.instantiateClass(Versions.FHIR_VERSIONS.R3, "ExplanationOfBenefit");
        assertEquals(org.hl7.fhir.dstu3.model.ExplanationOfBenefit.class, obj2.getClass());
        assertThrows(RuntimeException.class, () -> Versions.instantiateClass(Versions.FHIR_VERSIONS.R4, "EOB"));
        Object obj3 = Versions.instantiateClass(Versions.FHIR_VERSIONS.R3, "OperationOutcome", "OperationOutcomeIssueComponent");
    ...
    void executeInstantiateEnum() throws Exception {
        Object obj = Versions.instantiateEnum(Versions.FHIR_VERSIONS.R4, "OperationOutcome", "IssueSeverity", "ERROR");
    ...
    void executeSubObject() throws NoSuchMethodException, IllegalAccessException, InstantiationException, VersionNotSupported, InvocationTargetException, ClassNotFoundException {
        Object obj = Versions.instantiateClass(Versions.FHIR_VERSIONS.R4, "OperationOutcome", "OperationOutcomeIssueComponent");
        assertEquals(OperationOutcome.OperationOutcomeIssueComponent.class, obj.getClass());
    }

    @Test
    void testInvalidVersion() {
        assertThrows(RuntimeException.class, () -> Versions.instantiateClass(Versions.FHIR_VERSIONS.R3, "Bogus"));
        assertThrows(RuntimeException.class, () -> Versions.getClassName(null, "Bogus"));
        assertThrows(RuntimeException.class, () -> Versions.instantiateClassWithParam(Versions.FHIR_VERSIONS.R3, "Bogus", "dumb", String.class));
        assertThrows(ClassNotFoundException.class, () -> Versions.instantiateEnum(Versions.FHIR_VERSIONS.R3, "Bogus", "dumb", "ONE"));
    }

    @Test
    void executeInstantiateSimpleEnum() throws Exception {
        Object obj = Versions.instantiateEnum(Versions.FHIR_VERSIONS.R4, "Enumerations", "ResourceType", "PATIENT");
    ...
    void getVersionFromURL() {
        ...
        assertEquals(Versions.FHIR_VERSIONS.R3, Versions.getVersionFromUrl(url1));
        assertEquals(Versions.FHIR_VERSIONS.R4, Versions.getVersionFromUrl(url2));
        assertEquals(Versions.FHIR_VERSIONS.R3, Versions.getVersionFromUrl(url3));
    }
    ...
    @Test
    void testGetVersion() {
        assertEquals(Versions.FHIR_VERSIONS.R3, Versions.getVersion(FhirContext.forDstu3()));
        assertEquals(Versions.FHIR_VERSIONS.R4, Versions.getVersion(FhirContext.forR4()));
