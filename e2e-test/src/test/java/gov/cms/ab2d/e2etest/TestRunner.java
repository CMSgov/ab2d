...
public class TestRunner {
    ...
    private void loadDockerComposeContainers(int apiPort) {
        ...
        DockerComposeContainer container = new DockerComposeContainer(composeFiles)
                ...
                .withLogConsumer("worker", new Slf4jLogConsumer(apiLogger)) // Use to debug, for now there's too much log data
                .withLogConsumer("api", new Slf4jLogConsumer(workerLogger));
