...
public class ApiResponseEventMapper extends SqlEventMapper {
    ...
    public void log(LoggableEvent event) {
        ...
        String query = "insert into event_api_response " +
                " (time_of_event, user_id, job_id, response_code, response_string, description, request_id, aws_id) " +
                " values (:time, :user, :job, :responseCode, :responseString, :description, :requestId, :awsId)";
