...
public class ApiText {
    ...
    public static final String RUNNING_JOBIDS = "URL of Current Jobs that are running, Run the DELETE API provided to remove job";
    ...
    public static final String MAX_JOBS = "Too Many Jobs Running, either wait for the jobs to finish or delete the job";
