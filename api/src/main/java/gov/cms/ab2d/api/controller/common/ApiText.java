...
public class ApiText {
    ...
    public static final String BULK_RESPONSE = "Absolute URL of an endpoint" +
    ...
    public static final String CANCEL = "Cancel Export Job";
    ...
    public static final String DOWNLOAD = "Downloads Export File";
    ...
    public static final String STATUS = "Status of export job";
