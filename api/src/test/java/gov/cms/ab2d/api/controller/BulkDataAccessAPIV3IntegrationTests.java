...
@Testcontainers
public class BulkDataAccessAPIV3IntegrationTests {
    ...
    void testBasicPatientExportWithHttps() throws Exception {
        ResultActions resultActions = this.mockMvc.perform(
                get(API_PREFIX_V3 + FHIR_PREFIX + PATIENT_EXPORT_PATH).contentType(MediaType.APPLICATION_JSON)
        ...
        assertEquals("https://localhost" + API_PREFIX_V3 + FHIR_PREFIX + PATIENT_EXPORT_PATH, startJobDTO.getUrl());
