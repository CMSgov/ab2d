pipeline {
    ...
    stages {
        ...
        stage('Run codeclimate tests') {
            ...
            steps {
                sh '''
                    export JACOCO_SOURCE_PATH=./api/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                        ./api/target/site/jacoco/jacoco.xml --input-type jacoco -o codeclimate.api.json

                    export JACOCO_SOURCE_PATH=./audit/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                        ./audit/target/site/jacoco/jacoco.xml --input-type jacoco -o codeclimate.audit.json

                    export JACOCO_SOURCE_PATH=./common/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                        ./common/jacoco/jacoco.xml --input-type jacoco -o codeclimate.common.json

                    export JACOCO_SOURCE_PATH=./filter/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                        ./filter/target/site/jacoco/jacoco.xml --input-type jacoco -o codeclimate.filter.json

                    export JACOCO_SOURCE_PATH=./hpms/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                        ./hpms/target/site/jacoco/jacoco.xml --input-type jacoco -o codeclimate.hpms.json
                    export JACOCO_SOURCE_PATH=./optout/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                        ./optout/target/site/jacoco/jacoco.xml --input-type jacoco -o codeclimate.optout.json

                    export JACOCO_SOURCE_PATH=./bfd/src/main/java; ./codeclimate/cc-test-reporter format-coverage
                    ./bfd/target/site/jacoco/jacoco.xml --input-type jacoco -o codeclimate.bfd.json

                    export JACOCO_SOURCE_PATH=./worker/src/main/java; ./codeclimate/cc-test-reporter format-coverage
