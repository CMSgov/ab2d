...
resource "aws_vpc_security_group_egress_rule" "idr_endpoint_http" {
  security_group_id            = module.service.task_security_group_id
  referenced_security_group_id = aws_security_group.idr_endpoint.id
...
resource "aws_vpc_security_group_egress_rule" "idr_endpoint_https" {
  security_group_id            = module.service.task_security_group_id
  referenced_security_group_id = aws_security_group.idr_endpoint.id
